...
<body>
    <div style="border: 2px solid black; width: 800px; margin: auto; margin-top: 60px; background-color: ivory; box-shadow: 2px 2px 2px greenyellow;">
        <h2 class="text-center" style="color: darkorange; text-shadow: black 1px 1px 1px; padding-top: 10px;">Edit Paramedik</h2>
        <form action="edit_paramedik.php?id=<?php echo $id; ?>" method="POST" style="margin-left: 100px;">
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <select id="gender" name="gender" class="custom-select">
                        ...
                        <option value="P" <?php if ($paramedik['gender'] == 'L') echo 'selected'; ?>>Perempuan</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <select id="kategori" name="kategori" class="custom-select">
                        <option value="<?php echo $paramedik['kategori']; ?>"><?php echo $paramedik['kategori']; ?>Pilih kategori</option>
            ...
            <!-- <div class="form-group row">
                <label for="kategori" class="col-3 col-form-label">Kategori</label>
                <div class="col-6">
                    <input required id="kategori" name="kategori" type="text" class="form-control" value="<?php echo $paramedik['telpon']; ?>">
                </div>
            </div> -->
