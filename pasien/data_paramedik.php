            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="table-responsive" style="background-color: honeydew;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td><a href='edit_paramedik.php?id=" . $row['id'] . "'>Edit |</a>
                                             <a href='delete_paramedik.php?id=" . $row['id'] . "'>Delete</a>
                                             </td>";
                                        }
                                        ?>
                                    </tbody>
                        ...
                        <a href="form_paramedik.php"><button class="btn btn-primary mb-1" style="margin-left: 10px;">Tambah Data</button></a>
                    </div>
                </div>
        </section>
        <!-- /.content -->
